...
Java_com_android_serialport_SerialPort_open(JNIEnv *env, jobject thiz, jstring path,
                                            jint baudrate, jint dataBits, jint parity,
...
Java_com_android_serialport_SerialPort_close(JNIEnv *env, jobject thiz) {
